            ...
            <div className="flex  w-full ">
                ...
                <div className=' w-full'>
                    ...
                    <div>
                        ...
                        {editenable === item.id && <input type="text" value={editText} onChange={(e) => setEditText(e.target.value)} className='bg-transparent w-full border-2 rounded-md p-1 ml-0  text-black outline-none' />}
                    </div>
